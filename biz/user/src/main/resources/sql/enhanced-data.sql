...
-- 初始化-用户信息表数据
-- ----------------------------
INSERT INTO sys_user VALUES(1, 103, 'admin', '若依', 'sys_user', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSOfvam/l0rOO/l1xkKkXPp1l2BT7AP4o7OLhceAh7WW', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
INSERT INTO sys_user VALUES(2, 105, 'ry', '若依', 'sys_user', 'ry@qq.com', '15666666666', '1', '', '$2a$10$7JB720yubVSOfvam/l0rOO/l1xkKkXPp1l2BT7AP4o7OLhceAh7WW', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
INSERT INTO sys_menu VALUES('4', '若依官网', '0', '4', 'http://ruoyi.vip', null, '', 0, 0, 'C', '0', '0', '', 'guide', 'admin', sysdate(), '', null, '若依官网地址');
